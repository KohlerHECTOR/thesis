...
\contribution{
    ...
    Contemporarily, \citet{pinto,baisero-ppo,baisero-dqn} developed asymmetric reinforcement learning algorithms that are specifically tailored to learn policies in POMDPs. We unify those two approaches.
    }
...
\keywords{Reinforcement learning, decision trees, POMDPs} % Your keywords
...
Learning such decision trees for sequential decision making problems is a relatively new research direction and most of the existing literature focuses on imitating neural networks.
...
This helps us understand why in practice it is often hard to learn decision trees from scratch in MDPs.}
\lipsum[1]
}
