...
In contrast, we study reinforcement learning (RL) algorithms that \textit{directly} train decision trees optimizing some trade-off of cumulative rewards and interpretability in a Markov decision process (MDP). 
