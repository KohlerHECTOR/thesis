...
\input{configuration/float_settings}
\input{configuration/figure_settings}

% Import float settings
\input{configuration/float_settings}

% Optimize figure and table placement
\usepackage{placeins}
\usepackage{etoolbox}
\AtBeginEnvironment{figure}{\FloatBarrier}
\AtBeginEnvironment{table}{\FloatBarrier}
...
\include{annexes/annexes_imitation}
