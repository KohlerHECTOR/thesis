...
\documentclass[11pt,space=onehalf,version=final]{yathesis}
%
...
\part{A Difficult Problem: Reinforcement Learning of Decision Tree Policies}
% 
% Premier chapitre
\include{corps/position-probleme-pomdp}
%
% Deuxième chapitre
\include{corps/developpement-pomdp}
\include{corps/developpement-pomdp-tabular.tex}

%
\include{corps/developpement-pomdp-classif}
% Troisième chapitre
%
%
% Deuxième partie éventuelle
\part{An Easier Problem: Decision Tree Induction as Solving MDPs}
%
% Quatrième chapitre
\include{corps/position-probleme-dpdt}
%
% Cinquième chapitre
\include{corps/developpement-dpdt}
%
% Sixième chapitre
\include{corps/conclusion-dpdt}


\part{Beyond Decision Trees: Evaluation of Interpretable Policies}
\include{corps/position-probleme-imitation}
\include{corps/developpement-probleme-imitation}
\include{corps/conclusion-imitation}
...
\include{annexes/annexes_pomdp}
\include{annexes/annexes_dpdt}
