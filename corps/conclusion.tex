...
In chapter~\ref{sec:exps2}, we show that there is no model class that obtains better interpretability-performance trade-off across all tasks.
This result further highlights the need for careful methodology when researching interpretability as it might not be enough to rely on the assumption that neural networks are less interpretable than decision trees.
