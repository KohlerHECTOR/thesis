...
In \cite{dt-maze}, authors prove that for maze-like MDPs, there always exists an optimal decision tree policy w.r.t.~\ref{def:mdp-obj} and provide an algorithm to find it. 
