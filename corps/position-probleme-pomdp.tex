    ...
    \Fn{\SubtreeFromPolicy{$o, \pi$}}{
        ...
        \Else{
            ...
            $o_L \leftarrow o; \quad o_R \leftarrow o$ \\
                         $o_L \leftarrow (L'_1, U'_1, \dots, L'_i, v, \dots, L'_n, U'_n); \quad o_R \leftarrow (L'_1, U'_1, \dots, L'_i, v, \dots, L'_n, U'_n)$ \\
...
Such problems are classical instances of Partially Observable MDPs (POMDPs) (cite) with the sole specifity being that the mapping from fully observable states to observations is fully deterministic: given a fully observable IBMDP state $(s_t, o_t)$, the partially observable state--the observation--is simply $o_t$, which contrats with themore general deifnition of POMDPs in which $o_t\sim\Omega(o_t|s_t)$.
This connection with POMDP was not done by the authors of IBMDPs.
...
We can also define Value functions:
