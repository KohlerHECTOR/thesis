...
Both classes of algorithms are known to converge to the optimal value or (locally) optimal policy under some conditions.
...
\begin{figure}
    ...
    \caption{DQN tricks added to the vanilla Q-learning (Alg.~\ref{alg:qlearning}). Courtesy of Antonin Raffin.}
\end{figure}
