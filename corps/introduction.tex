...
In (cite) the authors present the following open problems in interpretable RL:
...
Authors of VIPER showed that decision tree policy fitted with VIPER tend to have the RL objective value as Dagger trees while being more interpretable (less deep or with less nodes).
