...
Authors define the associated IBMDP with $\zeta=-0.01$ and parametric information gathering action space defined by $p=3$.
The discount factor used by the authors is $\gamma=1$.

We potentially defer from the original paper setting in the way we handle maximum depth limiation. 
