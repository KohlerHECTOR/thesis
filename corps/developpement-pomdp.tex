...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{images/images_part1/hyperparamter_importance_dqn.pdf}
    \caption{Custard DQN (cite) on CartPole.}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{images/images_part1/hyperparamter_importance_ppo.pdf}
    \caption{Custard DQN (cite) on CartPole.}
\end{figure}
