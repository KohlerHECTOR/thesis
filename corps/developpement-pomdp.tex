...
\begin{table}[h]
\centering
\caption{Asymmetric Sarsa Hyperparameter Space (1152 combinations)}
\begin{tabular}{lll}
\toprule
...
\begin{table}[h]
    ...
    \midrule
    Policy Gradient & POIBMDP & 420 \\
    JSJ & POIBMDP & 15 \\
    Policy Gradient & IBMDP & 420 \\
    Q-learning & POIBMDP & 288 \\
    Asym Q-learning & POIBMDP & 1152 \\
    Q-Learning & IBMDP & 288 \\
    Sarsa & POIBMDP & 288 \\
    Asym Sarsa & POIBMDP & 1152 \\
    Sarsa & IBMDP & 288 \\
    \bottomrule
    \end{tabular}
    \end{table}
