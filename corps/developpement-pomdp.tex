...
\begin{figure}
    ...
    Shaded areas represent the confidence interval at 95\% at each measure on the y-axis.}\label{fig:res-dqn}
\end{figure}
...
\begin{figure}
    ...
    Shaded areas represent the confidence interval at 95\% at each measure on the y-axis.}\label{fig:res-ppo}
\end{figure}
