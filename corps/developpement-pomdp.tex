...
Authors of~\cite{topin2021iterative} propose to parametrize the set of IGAs with $i \times q$ actions $\langle v_k, i \rangle$ with $v_k$ depending on the current observation $\boldsymbol{o}_t=(L'_1, U'_1, \dots, L'_i, U'_i, \dots, L'_p, U'_p)$: $v_k = \frac{k(U'_i - L'_i)}{q+1}$.
