...
Hence they are able to retrieve the optimal depth-1 decision tree classifier (Fig.~\ref{example:cmdp}) most of the time in the optimality range $\zeta\in ]0, 1[$ (cf. Fig.~\ref{fig:tree-distrib-classif-poibmdp}).
