...
However, we observe that asymmetric versions of Q-learning and Sarsa have found the optimal policy, the depth 1 decision tree, more frequently than their symmetric counter-parts for $\zeta\in ]0, 1[$.
