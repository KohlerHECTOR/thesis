...
\title[Interpretability, Decision Trees, and Sequential Decision Making]{Interpr\'etabilit\'e, Arbres de D\'ecision, et Prise de D\'ecision S\'equentielle}
%
...
\comue[logo=images/all_logos.png]{Scool}
...
\cosupervisor[corps=isfp,affiliation=Inria]{Riad}{Akrour}
\referee[corps=cr*,affiliation=Universit\'e de Lorraine, Inria]{Olivier}{Buffet}
\referee[professor,female,affiliation=Sorbonne Universit\'e,sepcorpaffilfrench={{ }à{ }}]{Aur\'elie}{Beynier}
\committeepresident[professor,female,affiliation=Universit\'e de Lorraine]{Lydia}{Boudjeloud-Assala}
% \committeepresident[professor,affiliation=Universit\'e de Lorraine]{Lydia}{Boudjeloud-Assala}
\examiner[corps=associateprofessornotmcf,affiliation=University of Pennsylvania]{Osbert}{Bastani}
\guest[corps=assistantprofessor,affiliation=Imperial College London,assistant]{Sonali}{Parbhoo}
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\keywords{apprentissage par renforcement, arbres de d\'ecision, interpr\'etabilit\'e}{reinforcement learning, deicision trees, interpretability}
