...
\begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{../images/images_part1/objective_values_plot.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{../images/images_part1/learning_curves.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{../images/images_part1/tree_distributions.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{../images/images_part1/algorithm_performance_comparison_flattened.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{../images/images_part1/learning_curves_classif.pdf}
