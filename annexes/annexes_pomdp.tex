...
\midrule
\textbf{Total Combinations} & \textbf{140} & \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\textbf{Total Combinations} & \textbf{192} & \\
\bottomrule
\end{tabular}
\end{table}
...
Optimistic & True, False & Optimistic initialization \\
\midrule
\textbf{Total Combinations} & \textbf{768} & \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{QL-IBMDP Hyperparameter Space (60 combinations)}
\begin{tabular}{lll}
\toprule
\textbf{Hyperparameter} & \textbf{Values} & \textbf{Description} \\
\midrule
Epsilon Start & 0.1, 0.3, 1.0 & Initial exploration rate \\
Epsilon Decay & 0.99, 0.999, 1.0 & Exploration rate decay \\
Lambda & 0.0, 0.1, 0.3, 0.6, 0.9 & Eligibility trace decay \\
Learning Rate (lr\_v) & 0.001, 0.005, 0.01, 0.05, 0.1 & State-action Q-learning rate \\
Optimistic & True, False & Optimistic initialization \\
\midrule
\textbf{Total Combinations} & \textbf{60} & \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{SARSA-IBMDP Hyperparameter Space (60 combinations)}
\begin{tabular}{lll}
\toprule
\textbf{Hyperparameter} & \textbf{Values} & \textbf{Description} \\
\midrule
...
Epsilon Decay & 0.99, 0.999, 1.0 & Exploration rate decay \\
Lambda & 0.0, 0.1, 0.3, 0.6, 0.9 & Eligibility trace decay \\
Learning Rate (lr\_v) & 0.001, 0.005, 0.01, 0.05, 0.1 & State-action SARSA learning rate \\
Optimistic & True, False & Optimistic initialization \\
\midrule
\textbf{Total Combinations} & \textbf{60} & \\
\bottomrule
...
\begin{table}[h]
\centering
\caption{Summary of All Algorithm Hyperparameter Spaces (2,320 total combinations)}
\begin{tabular}{llr}
\toprule
\textbf{Algorithm} & \textbf{Type} & \textbf{Total Hyperparameter Combinations} \\
\midrule
PG & Policy Gradient & 140 \\
PG-IBMDP & Policy Gradient & 140 \\
QL & Q-Learning & 192 \\
QL-Asym & Q-Learning & 768 \\
QL-IBMDP & Q-Learning & 60 \\
SARSA & SARSA & 192 \\
SARSA-Asym & SARSA & 768 \\
SARSA-IBMDP & SARSA & 60 \\
\midrule
\textbf{Total} & & \textbf{2,320} \\
\bottomrule
\end{tabular}
\end{table}