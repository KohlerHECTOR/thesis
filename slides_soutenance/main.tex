...
\begin{figure}
    ...
    \begin{tikzpicture}[
        ...
        \node<1-2>[robot] (robot_) at (-2.1,3.4) {
            \begin{minipage}{1.5cm}
                \centering
                \includesvg[width=0.4cm]{../images/images_intro/robot-svgrepo-com.svg}\\
                \small{Policy}
        ...
        \draw<1-2>[arrow_decision] (robot_) to node[above] {\small{Recommends}} (doctor_);
        \draw<3->[arrow_decision] (nn_) to node[above] {\small{Recommends}} (doctor_);
        % \draw<1-3>[arrow_decision] (doctor_) to node[below] {\small{Interprets}} (robot_);
        \draw<4->[arrow_decision, red] (doctor_) to node[below] {\small{Cannot interpret}} (nn_);
        ...
        % ML learning arrows
        \draw<2->[arrow] (environment) to[bend left=40] node[left] {
            \begin{minipage}{2cm}
                \centering
                \includesvg[width=0.5cm]{../images/images_intro/patient-clipboard-svgrepo-com.svg}\\
                \small{Treatment outcomes}
...
\begin{frame}{Fast like greedy trees, accurate like optimal trees}
    \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{mirror_accuracy_vs_cost.pdf}
    \caption*{Train accuracies against cost for detph-3 trees.}
    \end{figure}
\end{frame}
