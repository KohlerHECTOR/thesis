...
\end{figure}
\only<2->{\textbf{\textcolor{teal}{RL of decision tree policies in IBMDPs for classif. is RL of a standard policy in an MDP!}}\onslide<3->{\textbf{$\rightarrow$ \textcolor{teal}{easy to do \textcolor{purple}{\small \parencite{sutton}}.}}}}
\end{frame}
