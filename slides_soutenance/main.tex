...
\end{figure}
\pause\textbf{\warning No definition of interpretability in machine learning models!}
\end{frame}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        % Add state labels clockwise from bottom left
        \node<2-> at (7.5,0.5) {{\color{teal} $\rightarrow$}};
        \node<2-> at (8.5,0.5) {$\star$};
        \node<2-> at (8.5,0.7) {{\color{teal} $\uparrow$}};
        \node<2-> at (8.5,0.3) {{\color{teal} $\downarrow$}};
        \node<2-> at (8.7,0.5) {{\color{teal} $\rightarrow$}};
        \node<2-> at (8.3,0.5) {{\color{teal} $\leftarrow$}};
        \node<2-> at (8.5,1.5) {{\color{teal} $\downarrow$}};
        \node<2-> at (7.2,1.3) {{\color{teal} $\downarrow$}};
        \node<2-> at (7.5,1.5) {{\color{teal} $\rightarrow$}};
    \end{tikzpicture}}
