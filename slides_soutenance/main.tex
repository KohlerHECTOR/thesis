...
\end{figure}
Successful algorithms for non-sequential learning: {\tiny \textcolor{purple}{\parencite{breiman1984classification,oct,murtree,binoct,quantbnb}}} \dots What about SDM?
\end{frame}
...
\begin{minipage}{0.59\textwidth}
    \begin{figure}
        ...
        \end{tikzpicture}}
        \caption*{Markov decision processes {\tiny \textcolor{purple}{\parencite{puterman}}}.}
    \end{figure}
\end{minipage}%
\begin{minipage}{0.4\textwidth}
    \begin{itemize}
        \item RL {\tiny \textcolor{purple}{\parencite{sutton}}} aims to find a policy, $\pi: S \rightarrow A$ that maximizes:
        \begin{align*}
            \underset{\boldsymbol{s}_{t}\sim T}{\mathbb{E}}\left[\sum_{t=0}^{\infty} \gamma^t R(s_t, \pi(s_t))\right]
        \end{align*}

        \item Lots of succesful RL algorithms {\tiny \textcolor{purple}{\parencite{sutton,dqn,ppo}}}.
...
\begin{figure}
    ...
    \caption*{Imitation learning works well in practice to get interpretable policies {\tiny \textcolor{purple}{\parencite{milani-survey,viper,dagger}}} but no optimality guarantees.}
\end{figure}
\end{frame}
...
\end{tikzpicture}}
\caption*{Trajectory in an IBMDP of the grid world MDP {\tiny \textcolor{purple}{\parencite{topin2021iterative}}}. Actions build a decision tree policy and rewards control the interpretability-performance trade-off.}
\end{figure}
\end{frame}
...
\begin{alertblock}{Cons}
    \begin{itemize}
        ...
        \item Finding the best \textbf{deterministic} and \textbf{partially observable} policy is NP-hard {\tiny \textcolor{purple}{\parencite{littman1}}}!
    \end{itemize}
\end{alertblock}
\end{frame}
...
\begin{figure}
    ...
    \caption*{Distributions of final tree policies learned with various (asymmetric) RL algorithms {\tiny \textcolor{purple}{\parencite{sutton,learning-pomdp,sarsa-pomdp,baisero-ppo,baisero-dqn}}} across 100 seeds.
...
\begin{frame}{Perspectives for direct RL of decision tree policies.}
    \begin{itemize}
        ...
        \item Should we focus on indirect approaches? Hybrid approaches {\tiny \textcolor{purple}{\parencite{parbhoo}}}?
        \item Fixing the policy tree structure a priori (paramteric trees, {\tiny \textcolor{purple}{\cite{sympol}}})?
        \item Design algorithms that learn deterministic partially observable policies {\tiny \textcolor{purple}{\parencite{lambrechts2025informed,justif-asym}}}?
    \end{itemize}
...
\begin{itemize}
    ...
    \end{align*}
    \item Trees \textbf{interpretable} and \textbf{competitive with neural nets} {\tiny \textcolor{purple}{\parencite{grinsztajn2022tree}}}.
    \item Greedy algorithms \textcolor{red}{\textbf{sub-optimal accuracy}}, but \textcolor{green}{$\boldsymbol{O(2^D)}$} operations {\tiny \textcolor{purple}{\parencite{breiman1984classification,ID3,c45}}} .
    \item Optimal algorithms, \textcolor{green}{\textbf{optimal accuracy}}, but \textcolor{red}{$\boldsymbol{O((2Np)^D)}$} operations (NP-hard) {\tiny \textcolor{purple}{\parencite{oct,murtree,pystreed,chaouki2024branchesfastdynamicprogramming,npcomplete}}}.
\end{itemize}
\end{frame}
...
\begin{alertblock}{Challenges {\tiny \parencite{glanois-survey,lipton,rigourous}}}
\begin{itemize}
...
\begin{exampleblock}{The notion of \textit{simulatability} {\tiny \parencite{lipton}}}
\begin{itemize}
    ...
    \item Less parameters mean more interpretability {\tiny \textcolor{purple}{\parencite{study-0,study-4}}}.
    \item Time to formally verify a policy decreases with interpretability {\tiny \textcolor{purple}{\parencite{lens-complexity}}}.
\end{itemize}
\end{exampleblock}
\end{frame}

\begin{frame}{A methodology to measure policy interpretability without humans}
\begin{block}{Simulatability {\tiny \parencite{lipton}}}
\begin{enumerate}
...
\end{enumerate}
\end{block}
\begin{alertblock}{Not that simple in practice {\tiny \textcolor{purple}{\parencite{insight}}}}
\begin{itemize}
...
\begin{frame}{Conclusion: interpretable machine learning is a difficult research topic}
    ...
    \end{itemize}
    \begin{block}{My hope}
        Motivate interpretability by finding a real-world problem where interpretability is \textit{really} necessary {\tiny \textcolor{purple}{\parencite{festor}}}.
    \end{block}
\end{frame}
