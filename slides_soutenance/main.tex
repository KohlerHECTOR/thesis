...
\end{figure}}
\begin{itemize}
    \item<3->Less parameters means more interpretability {\small \textcolor{purple}{\parencite{study-0}}}.
    \item<4->Not always true that "trees are more interpretable than neural networks".
\end{itemize}
\end{frame}
