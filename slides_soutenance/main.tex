...
\end{figure}
\pause
Distributions of tree policies learned with (asymmetric) RL algorithms {\small \textcolor{purple}{\parencite{sutton,learning-pomdp,sarsa-pomdp,baisero-ppo,baisero-dqn}}} across 100 seeds as a function of the interpretability reward $\zeta$.
\end{frame}
...
\onslide<5->{\textbf{We show that deterministic partially observable policies for classification IBMDPs ($\Leftrightarrow$ decision tree policies) are in fact Markovian.}}
\end{frame}
...
\begin{figure}
    ...
    \caption*{Distributions oftree policies learned with various RL algorithms across 100 seeds.
    }
\end{figure}
\end{frame}
...
\begin{frame}{Perspectives for direct RL of decision tree policies.}
    \begin{itemize}
        \pause
        \item Interpretability for SDM problems can be difficult because of \textcolor{red}{\textbf{partial observability}}.
        \pause
