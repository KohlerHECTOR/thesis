...
\begin{minipage}{0.4\textwidth}
    \begin{itemize}
        \item RL {\small \textcolor{purple}{\parencite{sutton}}} aims to find a policy, $\pi: S \rightarrow A$ that maximizes:
        \begin{align*}
            \underset{\boldsymbol{s}_{t}\sim T}{\mathbb{E}}\left[\sum_{t=0}^{\infty} \gamma^t R(s_t, \pi(s_t))\right]
        \end{align*}

        \item Lots of succesful RL algorithms {\small \textcolor{purple}{\parencite{sutton,dqn,ppo}}}.
        \item No interpretability concerns.
    \end{itemize}
\end{minipage}
\end{frame}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        % Add state labels clockwise from bottom left
        \node at (7.5,0.5) {{\color{green} $\rightarrow$}};
        \node at (8.5,0.5) {$\star$};
        \node at (8.5,0.7) {{\color{green} $\uparrow$}};
        \node at (8.5,0.3) {{\color{green} $\downarrow$}};
        \node at (8.7,0.5) {{\color{green} $\rightarrow$}};
        \node at (8.3,0.5) {{\color{green} $\leftarrow$}};
        \node at (8.5,1.5) {{\color{green} $\downarrow$}};
        \node at (7.2,1.3) {{\color{green} $\downarrow$}};
        \node at (7.5,1.5) {{\color{green} $\rightarrow$}};
    \end{tikzpicture}}
    \caption*{A grid world MDP and optimal actions.}
    \end{figure}
    \begin{figure}
    \centering
    \scalebox{0.85}{\begin{tikzpicture}[
        ...
        \node[decision] (tree4_root) at (11.5,2) {$x \leq 1$};
        \node[leaf] (tree4_right) at (10.5,0) {$\rightarrow$};
        \node[leaf] (tree4_left) at (12.5,0) {$\leftarrow$};
    ...
    \end{tikzpicture}}
    \caption*{An optimal depth-1 decision tree policy and a sub-optimal depth-1 decision tree policy.}
    \end{figure}
\end{frame}
...
\begin{figure}
    ...
    \caption*{Imitation learning works well in practice to get interpretable policies {\small \textcolor{purple}{\parencite{milani-survey,viper,dagger}}} but no optimality guarantees.}
\end{figure}
\end{frame}
