...
\begin{frame}{Interpretability in SDM {\small \parencite{glanois-survey}}.}
    ...
    \only<2>{\begin{figure}
        ...
        \end{subfigure}
        \caption*{Local interpretability with saliency maps of different MDP states \textcolor{purple}{\small \parencite{saliency}}.}
    \end{figure}}
    % \only<3>{
    %     \begin{figure}
    %         \centering
    ...
    \end{tikzpicture}
    \only<3>{\caption*{Global interpretability with intrinsically interpretable policies.}}
\end{figure}
    }
\end{frame}
