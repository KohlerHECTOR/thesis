...
\textbf{\warning No concensus on what interpretability is.}
    \begin{itemize}
        \item<2->Evaluation dependent (e.g. with or without humans?) \textcolor{purple}{\small \parencite{rigourous}}.
        \item<3->Set of properties (e.g. transparency) \textcolor{purple}{\small \parencite{lipton}}.
        \item<4->Different aspects of SDM (e.g. MDP, RL algorithms, policy class \dots) \textcolor{purple}{\small \parencite{milani-survey,glanois-survey}}.
    \end{itemize}
\end{frame}
...
\begin{frame}{Explainability vs. interpretability}
    \only<2>{\begin{figure}
        ...
        \end{subfigure}
        \caption*{\textit{Explainability} of different decisions with post-hoc saliency maps \textcolor{purple}{\small \parencite{saliency}}.}
    \end{figure}}
    % \only<3>{
    %     \begin{figure}
    %         \centering
    ...
    \end{tikzpicture}
    \only<3>{\caption*{We aim for \textit{interpretability as a property} of policies.}}
\end{figure}
    }
\end{frame}
