...
\begin{itemize}
    ...
    \item Optimal algorithms (\cite{oct,murtree,pystreed,chaouki2024branchesfastdynamicprogramming} \dots) \textcolor{green}{\textbf{optimal accuracy}}, but time complexity in \textcolor{red}{$\boldsymbol{O((2Np)^D)}$}.
\end{itemize}
\end{frame}
