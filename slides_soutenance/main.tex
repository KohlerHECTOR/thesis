...
\begin{frame}{RL for memoryless policies in POMDPs}
    ...
    \onslide<5->{\begin{block}{Asymmetric RL}
        \begin{itemize}
            ...
            \item<7-> Value-based $\rightarrow$ learns $Q(o, a)$ with TD targets $U(s, a)$  \textcolor{purple}{\small \cite{baisero-dqn}}.
...
\end{figure}
\pause
Distributions of tree policies learned with (asymmetric) RL algorithms as a function of the interpretability reward $\zeta$.
\end{frame}
...
\begin{frame}{Fast like greedy trees, accurate like optimal trees}
    \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{mirror_accuracy_vs_cost.pdf}
